...
/******* SMART Class *******/
/***************************/
SMART::SMART(int _trialIndex, double _obstacleSpeed, double _robotSpeed, int scene_index, int _dynObsNum, vector<vector<double>> dynObsPosition, double _goalX, double _goalY, double _robotX, double _robotY): 
treeRoot(new node(_goalX, _goalY)), TRH(0.8), TOH(0.4), robotSpeed(_robotSpeed), obstacleSpeed(_obstacleSpeed), obstacleRadius(1.0), 
...
goalX(_goalX), goalY(_goalY), robotX(_robotX), robotY(_robotY), dynObsNum(_dynObsNum), iterationIndex(0), mainTreeID(1), newTreeID(1), 
LSR_size_current(3), LSR_size_max(2* max(mapROW, mapCOL) - 1), initDone(false), replanTrigger(false), robotInsideOHZ(false),
