...
int main(int argc, char *argv[])
{
	...
	int sceneIndex = 1;
	vector<double> goalState = {30.01, 30.01}; //{x, y}
	vector<double> robotInitState = {2.0, 2.0, 4.0}; //{x, y, speed}
	...
	SMART SMART(trialIndex, dynObsSpeed, sceneIndex, dynObsNum, dynObsPosition, robotInitState, goalState);
	while(true)
	{
		SMART.mainFunction();
