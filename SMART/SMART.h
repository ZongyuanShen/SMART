...
public:
    ...
    /*********************************/
    SMART(int, double, double, int, int, vector<vector<double>>, double, double, double, double);
    ~SMART();
    ...
    gridcell tiling[mapROW][mapCOL]; // Tiling structure to store tree information
